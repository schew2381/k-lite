...
- Workload containers get `--dns <their node's klite-net IP> --dns-search svc.klite`, a single upstream, because a second resolver racing NXDOMAINs corrupts name resolution in ways that only show under load.
